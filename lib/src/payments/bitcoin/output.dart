...
class TxOutput {
  ...
  Uint8List toBytes() {
    ...
    final data =
        Uint8List.fromList([...amountBytes, ...encodeVarint(scriptBytes.length), ...scriptBytes]);
    return data;
  }
  ...
  static (TxOutput, int) fromRaw(
    ...
    int value = ByteData.sublistView(txoutputraw, cursor, cursor + 8).getInt64(0, Endian.little);
    cursor += 8;
    ...
    return (
      TxOutput(
          ...
          scriptPubKey: Script.fromRaw(hexData: bytesToHex(lockScript), hasSegwit: hasSegwit)),
      cursor
    );
  }
  ...
  @override
  String toString() {
    return 'Output{scriptPubKey: $scriptPubKey, amount: $amount}';
  }
}
