...
class ECPublic {
  ...
  P2shAddress toP2pkhInP2sh({bool compressed = true}) {
    ...
    return P2shAddress.fromScript(scriptPubKey: addr.scriptPubkey, type: AddressType.p2pkhInP2sh);
  }
  ...
  P2shAddress toP2pkInP2sh({bool compressed = true}) {
    return P2shAddress(scriptPubKey: toRedeemScript(compressed: compressed));
  }
  ...
  P2shAddress toP2wpkhInP2sh({bool compressed = true}) {
    ...
    return P2shAddress.fromScript(scriptPubKey: addr.scriptPubkey, type: AddressType.p2wpkhInP2sh);
  }
  ...
  P2shAddress toP2wshInP2sh({bool compressed = true}) {
    ...
    return P2shAddress.fromScript(scriptPubKey: p2sh.scriptPubkey, type: AddressType.p2wshInP2sh);
  }
  ...
  Uint8List _calculateTweek(Uint8List public, {dynamic script}) {
    ...
    final tweek = taggedHash(Uint8List.fromList([...keyX, ...merkleRoot]), "TapTweak");
    return tweek;
  }
