...
main() {
  group('bitcoinjs-lib (addresses)', () {
    ...
    test('can generate a Testnet address', () {
      ...
      final address = new P2pkhAddress(pubkey: keyPair.publicKey.hex, networkType: testnet).address;
    ...
    test('can generate a Litecoin address', () {
      final litecoin = NETWORKS.litecoin;
      final keyPair = ECPair.makeRandom(network: litecoin, rng: rng);
      final wif = keyPair.toWIF();
      final address =
          new P2pkhAddress(pubkey: keyPair.publicKey.hex, networkType: litecoin).address;
